...
<body class="body">
   ...
   <br><a class="btn btn-danger" href="Attributions des sanctions.php">Retour</a><br><br>
        ...
        <table class="table">
                ...
                <tbody>
                    ...
                    $connection= new mysqli($servername, $user, $password, $database );
                        ...
                        $sql= "SELECT * FROM etudiant where nbreheures>= 10;";
                        ...
                        while($row = $result->fetch_assoc())
                        {
                            echo"
                                ...
                                <td>$row[blame]</td>
                                <td>
                                <a class='btn btn-dark' href='retraitavert.php?id=$row[id]'>Retrait Avertissement</a>
                                <a class='btn btn-danger' href='retraitblame.php?id=$row[id]'>Retrait Blâme</a>
                                </td>
                                </tr>
                            ";
                        }
